...
export const metadata: Metadata = {
  title: "okaiz.com — Marketplace IA de véhicules d'occasion Madagascar",
  description: "Achetez et vendez vos véhicules d'occasion en toute confiance à Madagascar. IA de détection d'arnaque, estimation de prix, recherche par photo. Voitures, motos, SUV, camionnettes.",
};
